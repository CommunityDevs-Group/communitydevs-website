...
//         <p className="text-gray-600 font-medium text-lg">{t('hero.subtitle')}</p>
//         <h1 className="text-5xl md:text-7xl font-bold text-[#1e1b4b] leading-tight">{t('hero.title')}</h1>
//         <p className="text-gray-500 text-xl">{t('hero.description')}</p>
//         <button className="bg-[#6366f1] text-white px-8 py-3 rounded-full font-semibold">{t('hero.button')}</button>
//       </div>

//       <div className="flex-1 flex flex-col items-center mt-12 md:mt-0">
//         <img src={people} alt="Devs" className="w-full max-w-lg h-auto" />
//         <div className="flex gap-4 mt-8">
//           <a href="https://www.instagram.com/communitydevs.group?igsh=MTJkZHNmbmJjNG5uZg%3D%3D" target="_blank" rel="noreferrer" 
