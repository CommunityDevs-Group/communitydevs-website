            ...
            <div className="flex items-center space-x-3 md:space-x-6">
              <div className="relative py-2" ref={langRef}>
                <div 
                  ...
                  className="flex items-center space-x-2 cursor-pointer px-3 md:px-4 py-2 bg-white/40 backdrop-blur-sm border border-indigo-100/50 rounded-full hover:bg-white hover:border-[#6366F1]/50 transition-all duration-300 shadow-sm"
                >
                  ...
                  <ChevronDown className={`w-3 h-3 text-indigo-400 transition-transform duration-300 ${isLangOpen ? 'rotate-180' : ''}`} />
                </div>
                ...
                <AnimatePresence>
                  {isLangOpen && (
                    <motion.div 
                      ...
                      exit={{ opacity: 0, y: 10 }}
                      className="absolute right-0 top-full w-40 md:w-48 z-[110] pt-3"
                    >
                        ...
                        {languages.map((lang) => (
                          ...
                          >
                            <div className="flex items-center gap-3">
                              ...
                              <span className={`text-[12px] md:text-[13px] ${i18n.language === lang.code ? 'font-bold' : 'font-medium'}`}>{lang.label}</span>
                            </div>
              ...
              <button className="hidden md:block bg-[#6366F1] text-white px-8 py-2.5 rounded-full font-semibold hover:bg-[#5254e2] transition-all active:scale-95 shadow-lg shadow-indigo-100">
                {t('nav.join')}
              </button>
